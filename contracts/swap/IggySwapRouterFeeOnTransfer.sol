...
contract IggySwapRouterFeeOnTransfer is OwnableWithManagers {
  ...
  function _swap(
    ...
    amounts = IUniswapV2Router02(routerAddress).swapExactTokensForTokensSupportingFeeOnTransferTokens(
      amountIn,
      amountOutMin,
      path,
